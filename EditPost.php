...
if(isset($_POST["submit"])){
    ...
    elseif (strlen($postDescription)>10000){
        ...
        if(!empty( $_FILES['image']['name'])){
            $sql = "update posts set title='$post_title',category='$Category',image='$image_name',post='$postDescription'where id = '$search'";
        }else{
        $sql = "update  posts set title='$post_title',category='$Category',post='$post'
        where id= '$search'";
        }
...
<body>
    ...
    <section class="container py-2 mb-4">
        ...
        ?>
        <form action="EditPost.php?id=<?php echo $search; ?>"method="post"class=""enctype="multipart/form-data">
        <div class="card bg-secondary text-light mb-3">
          
            <div class="card-body bg-dark">
                <div class="form-group">
                    <label for="title"><span class="FieldInfo">Post Title:</span></label>
                    <input type="text"name="post_title" id="title" placeholder="Type title here"class="form-control" value="<?php
                    echo $title;
                    ?>">
                </div>
                <div class="form-group">
                ...
                <textarea name="postDescription" class="form-control"id="post" cols="30" rows="10">
                    <?php echo $post; ?>
                </textarea>
                </div>
                <div class="row">
